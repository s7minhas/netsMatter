...
% 	\caption{Assessments of out-of-sample predictive performance for Weeks (2012) using ROC curves, PR curves, and separation plots.}
% \end{figure}
% \FloatBarrier
\clearpage
...
If directed, AMEN further calls for: 
