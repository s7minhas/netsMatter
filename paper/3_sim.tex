...
x is a vector of observed node-specific characteristics and w is a vector of unobserved node specific characteristics. We draw n values for both from a standard normal. For both x and we we then take the cross-product of their transpose to generate n x n matrices. Values for mu, beta, and gamma are set to -2, 1, and 1, respectively.
