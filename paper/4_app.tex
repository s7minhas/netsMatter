...
\begin{figure}
	\centering   
	\subfigure[AUC]{\label{fig:reitaucpr}\includegraphics[width=.45\textwidth]{reiter_auc_outsamp.pdf}}
	\subfigure[Precision and Recall]{\label{fig:reitpr}\includegraphics[width=.45\textwidth]{reiter_pr_outsamp.pdf}}
...
%The AME coefficient is not only in the opposite direction, but it is approximately three times more precisely estimated.  
