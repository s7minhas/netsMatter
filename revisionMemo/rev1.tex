...
\begin{enumerate}
	...
	\begin{itemize}
		\item \textcolor{blue}{ \emph{
		TO DO/CD: We have revised this opening statement to clarify our position. Max: I'm wondering if we should combine this with the Q above or is R1's question here distinct enough?
		}}
	\end{itemize}
