...
sort dyad
merge dyad using "trilateral", nokeep keep(yt)
replace yt=0 if yt==.
gen y = yt+yb
drop yt yb 
...
di "Iteration: " `s'
local coef_cap_dyad = `coef_cap_dyad' + `coef`s''
di "Dyad coefficient: " `coef_cap_dyad'/`s'
