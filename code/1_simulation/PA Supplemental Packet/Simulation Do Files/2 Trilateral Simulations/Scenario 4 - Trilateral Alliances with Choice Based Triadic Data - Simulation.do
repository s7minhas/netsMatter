...
save "C:\Users\Paul\Desktop\trilateral.dta", replace




use "C:\Users\Paul\Desktop\trilateral.dta", clear
...
replace SAMP = 1 if nummem==`i' & id_sort<=`num`i'' & y==0
local NUM = `NUM' + `num`i''
local i = `i' + 1
}
...
*capture relogit y cap_ratio [pw=1/weight]
