...
ameFit = ame_repL(
  ...
  plot=FALSE, print=FALSE, gof=TRUE,
  periodicSave=TRUE,
  outFile='/Users/jordan/Dropbox/netsMatter/replications/gartzke2007/Replication\ specific\ data/ameFit_k0.rda'
)
save(ameFit,
     file='/Users/jordan/Dropbox/netsMatter/replications/gartzke2007/Replication\ specific\ data/ameFit_k0.rda')
...
ameFit = ame_repL(
  ...
  plot=FALSE, print=FALSE, gof=TRUE,
  periodicSave=TRUE,
  outFile='/Users/jordan/Dropbox/netsMatter/replications/gartzke2007/Replication\ specific\ data/ameFit_k1.rda'
)
save(ameFit,
     file='/Users/jordan/Dropbox/netsMatter/replications/gartzke2007/Replication\ specific\ data/ameFit_k1.rda')
...
ameFit = ame_repL(
  ...
  plot=FALSE, print=FALSE, gof=TRUE,
  periodicSave=TRUE,
  outFile='/Users/jordan/Dropbox/netsMatter/replications/gartzke2007/Replication\ specific\ data/ameFit_k2.rda'
)
save(ameFit,
     file='/Users/jordan/Dropbox/netsMatter/replications/gartzke2007/Replication\ specific\ data/ameFit_k2.rda')
...
ameFit = ame_repL(
  ...
  plot=FALSE, print=FALSE, gof=TRUE,
  periodicSave=TRUE,
  outFile='/Users/jordan/Dropbox/netsMatter/replications/gartzke2007/Replication\ specific\ data/ameFit_k3.rda'
)
save(ameFit,
     file='/Users/jordan/Dropbox/netsMatter/replications/gartzke2007/Replication\ specific\ data/ameFit_k3.rda')
