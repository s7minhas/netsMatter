...
dyadicVars <- c('mzinit', "dependlow" , "majmaj", "minmaj", "majmin", "contigdum",
...
form_mod2 <- formula(paste0('value ~ ',
    paste(colnames(yCrossValTrain[[1]])[8:29], collapse = '+')))
...
## how does this perform with just dyadic vars
...
save(out, file=paste0(savepath, "weeksOutPerf.rda"))
