...
# load dta data
dataPath = '/Users/howardliu/Dropbox/netsMatter/replications/gibler/'
data = read.dta13(paste0(dataPath,"rep data apsr.dta")) # 1 min
gilberData <- data
data <- gilberData
# packages
...
# save dfs
#ave(yList, xDyadList, file=paste0(dataPath, 'amenData_gilber.rda'))
