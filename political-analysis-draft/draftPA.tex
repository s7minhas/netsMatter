...
We also examine the accuracy of the predictions made with each approach. Finally, we assess whether there is any substantive finding that emerges or indeed if any disappear once the interdependencies in the data are modeled.%%%Dont we want to talk more about performance here???? - MG
