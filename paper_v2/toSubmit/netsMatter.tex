...
\makeatletter
% \def\input@path{{/Users/janus829/Dropbox/toDo_notes/nsfSumm/}, {/Users/s7m/Dropbox/toDo_notes/nsfSumm/}}
% \graphicspath{{/Users/janus829/Dropbox/toDo_notes/nsfSumm/}, {/Users/s7m/Dropbox/toDo_notes/nsfSumm/}}
...
\begin{figure}
	\begin{tabular}{cc}
		...
		\includegraphics[width=.4\textwidth]{adjRowDep.png} &
		\includegraphics[width=.4\textwidth]{adjColDep.png} \\
		\textsc{Sender-Receiver Covariance} & \textsc{Reciprocity} \\
		\includegraphics[width=.4\textwidth]{adjRowColCovar.png} &
...
\begin{figure}
	...
	\begin{tabular}{cc}
		...
		\includegraphics[width=.4\textwidth]{figure6_reiter_stam_roc_outSample.pdf} &
		\includegraphics[width=.4\textwidth]{figure6_reiter_stam_pr_outSample.pdf} \\
		\multicolumn{2}{l}{\textbf{\tiny{Weeks (2012)}}} \\
		\includegraphics[width=.4\textwidth]{figure6_weeks_roc_outSample.pdf} &
		\includegraphics[width=.4\textwidth]{figure6_weeks_pr_outSample.pdf} \\
		\multicolumn{2}{l}{\textbf{\tiny{Gibler (2017)}}} \\
		\includegraphics[width=.4\textwidth]{figure6_gibler_roc_outSample.pdf} &
		\includegraphics[width=.4\textwidth]{figure6_gibler_pr_outSample.pdf} \\
	\end{tabular}
...
\begin{figure}[ht]
	\begin{tabular}{cc}
	\includegraphics[width=.7\textwidth]{figure7a.pdf} &
	\includegraphics[width=.3\textwidth]{figure7b.pdf} \\
	\end{tabular}
...
\begin{figure}[ht]
	...
	\includegraphics[width=1\textwidth]{appendix_figureC1.pdf} \\
\end{figure}
...
\begin{figure}[ht]
	...
	\includegraphics[width=1\textwidth]{appendix_figureC2.pdf} \\
\end{figure}
...
\includegraphics[width=1\textwidth]{appendix_figureD1a.pdf} \\
\end{figure}
...
\includegraphics[width=1\textwidth]{appendix_figureD1b.pdf} \\
\end{figure}
