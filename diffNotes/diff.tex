...
%DIF DEL netsMatter_v1.tex   Mon Jul  5 10:44:33 2021
%DIF ADD netsMatter_v2.tex   Mon Jul  5 10:47:49 2021
      % \newif\ifpreview
      % \previewfalse
...
\begin{figure}
	...
	\label{fig:ameBias}
	\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\textwidth]{graphics/ameSimBias_all.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\textwidth]{graphics/figure3.pdf} \DIFaddendFL \\
\end{figure}
...
\begin{figure}
	...
	\label{fig:ameCalib}
	\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\textwidth]{graphics/ameSimCover_all.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\textwidth]{graphics/figure4.pdf} \DIFaddendFL \\
\end{figure}
...
\begin{figure}
	...
	\label{fig:ameCorr}
	\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\textwidth]{graphics/ameSimCorr.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\textwidth]{graphics/figure5.pdf} \DIFaddendFL \\
\end{figure}
...
\begin{figure}
	...
	\begin{tabular}{cc}
		...
		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.4\textwidth]{graphics/reiter_stam_roc_outSample.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.4\textwidth]{graphics/figure6_reiter_stam_roc_outSample.pdf} \DIFaddendFL &
		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.4\textwidth]{graphics/reiter_stam_pr_outSample.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.4\textwidth]{graphics/figure6_reiter_stam_pr_outSample.pdf} \DIFaddendFL \\
		\multicolumn{2}{l}{\textbf{\tiny{Weeks (2012)}}} \\
		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.4\textwidth]{graphics/weeks_roc_outSample.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.4\textwidth]{graphics/figure6_weeks_roc_outSample.pdf} \DIFaddendFL &
		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.4\textwidth]{graphics/weeks_pr_outSample.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.4\textwidth]{graphics/figure6_weeks_pr_outSample.pdf} \DIFaddendFL \\
		\multicolumn{2}{l}{\textbf{\tiny{Gibler (2017)}}} \\
		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.4\textwidth]{graphics/gibler_roc_outSample.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.4\textwidth]{graphics/figure6_gibler_roc_outSample.pdf} \DIFaddendFL &
		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.4\textwidth]{graphics/gibler_pr_outSample.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.4\textwidth]{graphics/figure6_gibler_pr_outSample.pdf} \DIFaddendFL \\
	\end{tabular}
...
\begin{figure}[ht]
	\begin{tabular}{cc}
	\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.7\textwidth]{graphics/reiter_stam_aEff_map.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.7\textwidth]{graphics/figure7a.pdf} \DIFaddendFL &
	\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.3\textwidth]{graphics/reiter_stam_aEff_line.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.3\textwidth]{graphics/figure7b.pdf} \DIFaddendFL \\
	\end{tabular}
...
The visualization of the sender random effects highlights that the behavior of countries does not fully accord with predictions from the covariates specified by Reiter \& Stam. Specifically, we can see that countries such as Iraq, Israel, \DIFdelbegin \DIFdel{Egypt, }\DIFdelend and Iran are more likely to be involved in initiating or continuing conflict with other countries than the model would predict. Further, other countries such as \DIFdelbegin \DIFdel{Bhutan}\DIFdelend \DIFaddbegin \DIFadd{Sweden}\DIFaddend , Finland, and \DIFdelbegin \DIFdel{Turkmenistan }\DIFdelend \DIFaddbegin \DIFadd{Swaziland }\DIFaddend are less likely to engage in conflict than the exogenous covariates in the model would suggest. In this case, the finding that countries in the middle east experience more conflict with other countries might lead one to more carefully examine the effects of geography on conflict initiation or to account for \citet{colgan:2010}'s theory that revolutionary petrostates are more aggressive. None of these findings change the key conclusion from Reiter \& Stam's work, but by using the AME framework we are able to better understand the limitations of their model.
...
Figure~\ref{fig:weekscirc} reveals a number of notable clusters. For example, in the \DIFdelbegin \DIFdel{top left }\DIFdelend \DIFaddbegin \DIFadd{bottom right }\DIFaddend corner we see the US, UK, Germany, Canada, and Israel. These states cluster together in the outer ring of this visualization because they tend to send conflicts to similar targets. Conversely, in the \DIFdelbegin \DIFdel{bottom right }\DIFdelend \DIFaddbegin \DIFadd{top left }\DIFaddend of the outer ring, we see a cluster of authoritarian countries: Iraq, Russia, Syria, North Korea, and China. We observe similar clusters in the inner ring. Specifically, we again see the US, UK, Germany, Canada, and Israel clustering together indicating that they are more likely to receive conflict from the same countries.  The  cluster of democratic and authoritarian countries facing each other in the inner and outer rings indicate that they are more likely to engage in conflict with one another.
...
\begin{figure}
	...
	\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{graphics/gibler_margeff.pdf}
%DIFDELCMD <  	%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{graphics/figure9.pdf}
 	\DIFaddendFL \label{fig:gibmargeff}
 \end{figure}

As Figure~\ref{fig:gibmargeff} illustrates, the substantive results differ notably. The expected value of the dependent variable---the probability of the onset of a militarized interstate dispute, is considerably lower once interdependencies are taken into account with the AME model.  These are rare events, so the probabilities are low, but the difference \DIFdelbegin \DIFdel{is a factor of almost two.
Thus, we find substantially different expected values from these two models.
}\DIFdelend \DIFaddbegin \DIFadd{in predictions is notable.
}\DIFaddend 
...
%DIF <  \bibliography{/Users/maxgallop/documents/whistle/master}
%DIF <  \bibliography{/Users/howardliu/documents/whistle/master}
%\bibliography{/Users/s7m/whistle/master}
%DIF <  \bibliography{/Users/mdw/Git/whistle/master}
  %DIF < \bibliography{/Users/dorffc/ProjectsGit/whistle/master}
...
\DIFdelbegin %DIFDELCMD < \input{reiter_stam_coeftable}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \input{graphics/appendix_tableB1}
...
\DIFdelbegin %DIFDELCMD < \input{weeks_coeftable}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \input{graphics/appendix_tableB2}
\DIFaddend \FloatBarrier
...
\DIFdelbegin %DIFDELCMD < \input{gibler_coeftable}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \input{graphics/appendix_tableB3}
\DIFaddend \FloatBarrier
...
\begin{figure}[ht]
	...
	\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\textwidth]{graphics/ameSimBias_all_asaProbit.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\textwidth]{graphics/appendix_figureC1.pdf} \DIFaddendFL \\
\end{figure}
...
\begin{figure}[ht]
	...
	\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\textwidth]{graphics/ameSimCover_all_asaProbit.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\textwidth]{graphics/appendix_figureC2.pdf} \DIFaddendFL \\
\end{figure}
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\textwidth]{graphics/ameSimBias_all_corrProbitMed.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\textwidth]{graphics/appendix_figureD1a.pdf} \DIFaddendFL \\
\end{figure}
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\textwidth]{graphics/ameSimBias_all_corrProbitHi.pdf} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\textwidth]{graphics/appendix_figureD1b.pdf} \DIFaddendFL \\
\end{figure}
